...
#
# IoT_platform.tcl: Tcl script for re-creating project 'IoT_platform'
#
...
set _xil_proj_name_ "IoT_platform"
...
set script_file "IoT_platform.tcl"
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xc7z020clg484-1 -quiet -force
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../ip_repo/AES128CTR_1.0"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/IoT_platform.srcs/sources_1/bd/design_1/design_1.bd" ]\
 [file normalize "${origin_dir}/IoT_platform.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]\
]
